...
urlpatterns = [
    ...
    path('project/<slug:slug>/<int:id>/print/', views.printOverview, name='printOverview'),
    ...
    path('project/<slug:slug>/<int:id>/userSettings/', views.userSettings, name='userSettings'),
